...
(function(A){
    A.fn.slides=function(B){
                ...
                if(!H&&U){
                    ...
                    switch(c){
                        ...
                        case"prev":
                            ...
                            P=O;
                            break;
                        case"apptha_pagination":
                            O=parseInt(a,10);
                            N=A("."+B.apptha_paginationClass+" li."+B.currentClass+" a",V).attr("href").match("[^#/]+$");
                            if(O>N){
                            X=Q*2;
                            c=-Q*2;
                        }else{
        ...
        if(B.apptha_pagination){
            A("."+B.apptha_paginationClass+" li."+B.currentClass,V).removeClass(B.currentClass);
            A("."+B.apptha_paginationClass+" li:eq("+O+")",V).addClass(B.currentClass);
        }
    }
}
function R(){
...
if(B.generatePagination){
    if(B.prependPagination){
        V.prepend("<ul class="+B.apptha_paginationClass+" ></ul>");
    }else{
        V.append("<ul class="+B.apptha_paginationClass+"></ul>");
    }
    J.children().each(function(){
        A("."+B.apptha_paginationClass,V).append('<li><a href="#'+C+'">'+(C+1)+"</a></li>");
        C++;
    });
}else{
    A("."+B.apptha_paginationClass+" li a",V).each(function(){
        A(this).attr("href","#"+C);
        C++;
    });
}
A("."+B.apptha_paginationClass+" li:eq("+D+")",V).addClass(B.currentClass);
A("."+B.apptha_paginationClass+" li a",V).click(function(){
    if(B.play){
        G();
    }
    I=A(this).attr("href").match("[^#/]+$");
    if(P!=I){
        E("apptha_pagination",S,I);
    }
    return false;
});
...
A.fn.slides.option={
    ...
    next:"next",
    prev:"prev",
    apptha_pagination:true,
    generatePagination:true,
    prependPagination:false,
    apptha_paginationClass:"apptha_pagination",
